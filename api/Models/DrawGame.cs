...
namespace api.Models
{
    public class DrawGame
    {
        ...
        public List<string> FunnyPlaceholderImages { get; set; } = new List<string>
        {
            ...
            "birdie_placeholder.png",
            "butterfly_placeholder.png",
            "caterpillar_placeholder.png",
            "cute_bee_placeholder.png",
            "flower_placeholder.png",
            "froggie_placeholder.png",
            "mouse_placeholder.png",
            "pigeon_placeholder.png",
            "seal_placeholder.png",
            "seaturtle_placeholder.png",
            "singing_mouse_placeholder.png",
            "strawberry_placeholder.png",
        ...
        public List<string> Prompts { get; set; } = new List<string>
        {
            ...
            "sea snail",
            "too much sunscreen",
            "someone telling a really boring story",
            "day at the zoo",
            "business of ferrets",
            ...
            "huge bowl of rice",
            "piñata",
            "medium sized termite",
            "mushroom farm",
            "mother of dragons",
            "pineapple surprise",
            "nasty fruitcake",
            "stank garbage",
            "a fly carrying a gnat",
            "big bad wolf knitting a doily",
            "spot of tea and crumpets",
            "snake with its tongue out",
            "basilisk",
            "medusa",
            "pyramid next to a smaller pyramid",
            "the sphinx",
            "the colliseum",
            "a tasty gelato",
            "mmm chocolate",
            "candlestick",
            "fireplace",
            "rager at mom's house",
            "saguaro cactus",
            "chode cactus",
            "saltine crackers",
            "silly billy",
            "silly goose",
            "coyote chasing a roadrunner",
            "iguana manicure",
            "pigeon pedicure",
            "fancy fox",
            ...
            "brocolli",
            "spinach salad",
            "kid wearing floaties",
            "that's note a knoife, now that's a knoife",
            "alligator",
            "crocodile dancing",
